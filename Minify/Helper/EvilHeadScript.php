 ...
 */
echo '123';
class Evil_Minify_Helper_EvilHeadScript extends Zend_View_Helper_HeadScript {
	 ...
	 */
	public function EvilHeadScript($mode = Zend_View_Helper_HeadScript::FILE, $spec = null, $placement = 'APPEND', array $attrs = array(), $type = 'text/javascript') {
	...
	public function toString($indent = null) {
		...
		return '1111' . $indent . implode($this->_escape($this->getSeparator()) . $indent, $items);
	}
